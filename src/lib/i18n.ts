...
export const STRINGS = {
  en: {
    ...
    criteriaHeight:
      "Level Δ: safe 0.10–0.45 m, caution near 0.45–0.79 m, danger above 0.79 m or below −0.24 m.",
    criteriaSpeed:
  ...
  de: {
    ...
    criteriaTitle: "Wie wir beurteilen",
    criteriaHeight:
      "Wasserstand Δ: sicher 0.10–0.45 m, Vorsicht 0.45–0.79 m, Gefahr über 0.79 m oder unter −0.24 m.",
    criteriaSpeed:
    ...
    close: "Schliessen",
    reasonSafe: "Strömung, Stand & Wetter sind alle gut",
